...
const Privacy_Policy = () => {
  return (
    <>
    <Head>
      <title>Privacy Policy | Bendando Websites and Apps</title>
      <meta name="description" content="Bendando Websites, Apps, SEO and Digital Marketing | Privacy Policy"/>
      <meta name="keywords" content="Bendando, Websites, Apps, Privacy, Policy" /> 
      </Head>
    <div style={{marginTop: '120px'}}></div>
      
      <div className='container py-4'>
        <h1 className="pt-4">Bendando Privacy Policy</h1>
            <h6 className='pb-4'>This Privacy Policy describes how your personal information is collected, used, and shared when you visit  https://http://www.bendando.com/ (the “Site”).</h6>
            ...
            <p className='pb-2'>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:enquiries@bendando.com">enquiries@bendando.com</a> or by mail using the details provided below:</p>
            <p className='pb-2'>Bendando Ltd, Unit 6, Princess Mews Horace Road, Kingston-upon-Thames, Surrey, KT1 2SZ, United Kingdom</p>
            </div>
