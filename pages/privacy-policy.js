    ...
    <div style={{marginTop: '120px'}}></div>
      ...
      <div className='container py-4'>
        <h1 className="pt-4">Bendando Privacy Policy</h1>
            <h6 className='pb-4'>This Privacy Policy describes how your personal information is collected, used, and shared when you visit https://www.bendando.com/ (the “Site”).</h6>
