...
export const ServiceData = [
  {
    ...
    text: "Whether you have a small website that requires nothing more than a few alteration to a template to stand out or a larger website or application that requires branding we have solution for you.",
  },
  {
    index: 2,
    icon: "fas fa-desktop",
  ...
  },
  {
    ...
    text: "With experience working for Microsoft, Vodaphone, the NHS, PWC and Fintech Startups we have the skills to deliver an ontime on budget solution for whatever your needs. Rather than hire us through an agency, come to us directly and we can deliver you product at a fraction of the price.",
  },
  {
    index: 4,
    icon: "fas fa-search",
  ...
  },
  {
    ...
    text: "PPC (pay per click) using google Adwords, combined with a Facebook and Instagram advertising campaigns can take your online presence to the next level. By targeting your customer base, monitoring success and making iterative improvements we can boost your website traffic and customer engagement.",
  },
  {
    index: 7,
    icon: "fas fa-tasks",
  ...
  },
  {
    ...
    text: "We build GDPR compliant databases or integrate with your own to collect whatever information is required from your users. Recently we ran a lottery competition with Uri Gellar to win a flat. Whatever you requirements we can provide a cost effective solution.",
  },
];
